...
function App() {
  ...
  return (
    <div>
      ...
      <main className='relative mt-[5%] flex flex-row items-center justify-center gap-[5%] '>
        ...
        <div className='p-[1%] w-[20%] flex flex-col gap-[14%] justify-center items-center  fixed bottom-[5%] left-[0%]'>
          <FontAwesomeIcon icon={faGithub} className='text-[1.5rem] text-[#fff]  pt-[1.5%] fixed bottom-[26%] left-[8.7%]'/>
        <FontAwesomeIcon icon={faLinkedin} className='text-[1.5rem] text-[#fff]  pt-[1.5%] fixed bottom-[22%] left-[8.7%]'/>
